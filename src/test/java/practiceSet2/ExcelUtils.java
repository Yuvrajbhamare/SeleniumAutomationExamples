...
public class ExcelUtils {
	...
	public static String getCellData(String xlfile, String xlsheet, int rownum, int colnum) throws IOException {
		...
		try 
		{
			...
			data = formatter.formatCellValue(cell);// Returns formatted value of a cell as a string regardless of the
													// cell type,it is same as toString() method,just given here for
													// knowledge
