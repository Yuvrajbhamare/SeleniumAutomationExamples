...
public class DropDownCalender {
	...
	public static void main(String[] args) 
	{
	   ...
	   // ChromeOptions options=new ChromeOptions();
	    //File file = new File("C:\\Users\\Lenovo\\Downloads\\AutomationFilesCRX2\\CRX-Extractor-Downloader-Chrome-Web-Store.crx");
	   ...
	   // ChromeDriver driver=new ChromeDriver(options);
	    ...
	    WebElement iframe1=driver.findElement(By.xpath("//iframe[@class='demo-frame' and @src='../../demoSite/practice/datepicker/dropdown-month-year.html']"));
