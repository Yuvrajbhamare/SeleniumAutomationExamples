...
public class DataProviderConcept {
	...
	Object[][] logindata() {
		Object Data[][] = { { "yuvrajbhamare11@gmail.com", "Admin@123" }, { "yuvrajbhamare12@gmail.com", "Admin@1234" },
				{ "yuvrajbhamare14@gmail.com", "Admin@125" }, };
		return Data;

	}

	// if want multiple data providers into multiple methods,we can create,juts we
	// need to give different names to data provider methods like
	// name=dp,name=dp1,name=dp3 etc
	// if want Data provider data based on the choice,for first and last data only
	@DataProvider(name = "dp2", indices = { 0, 2 })
	Object[][] logindata2() {
		Object Data[][] = { { "yuvrajbhamare11@gmail.com", "Admin@123" }, // 0
